  ...
  return (
    <header>
      ...
      <div className="nav-bar">
        <ul className="text-[#500000]">
          <li>
            <a href="">Transparencia</a>
          </li>
          <li>
            <a href="">Arm. Contable</a>
          </li>
          <li>
            <a href="">Licitaciones</a>
          </li>
          <li>
            <a href="">Protocolo Acoso</a>
          </li>
          <li>
            <a href="">Archivo y Gestión Documental</a>
          </li>
          <li>
            <a href="">Contraloría Social</a>
          </li>
          <li>
            <a href="">Planeación y Evaluación</a>
          </li>
          <li>
            <a href="">NMX-R-025-SCFI-2015</a>
          </li>
        </ul>
      </div>
